...
if [ -d './Hyprland' ]; then
 ...
 git clone https://github.com/hyprwm/Hyprland.git -b wayland-protocol-improvements 
fi
if [ -d './wlroots' ]; then
    echo 'Directory exists'
else
...
git clone https://github.com/canihavesomecoffee/udis86.git
   fi
